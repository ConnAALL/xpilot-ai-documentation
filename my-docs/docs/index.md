...
## 📚 [Function Library](docs-library.md)
...
> **Note:** Documentation for the previous, now retired versions of Xpilot-AI can be found [here](http://xpilot-ai.org/legacy).
...
## 🚀 [Examples & Getting Started](docs-examples.md)
...
> **Additional Examples:** More example bots can be found [here](http://xpilot-ai.org/examples).
...
| Section | Description |
|---------|-------------|
| [📚 Library](docs-library.md) | Complete function reference |
| [🔄 Versions](docs-versions.md) | Version info & features |
| [🔧 Install](docs-install.md) | Installation instructions |
| [🚀 Examples](docs-examples.md) | Code examples & tutorials |
| [ℹ️ About](docs-about.md) | Project info & links |
