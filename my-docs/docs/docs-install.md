# XPilot-AI Installation Guide

## Linux

### Xpilot-AI 1.1 (Ubuntu 12.04)
...
2. Open Xcode in order to agree to the Xcode/iOS license
3. Install **XQuartz** from [https://www.xquartz.org/](https://www.xquartz.org/)
...
### Xpilot-AI 1.0 (Mac OS X Snow Leopard)
